                    ...
                    <div class="panel">
                        <div class="panel-heading mt-10 ml-20">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <table>
                                        <form action="<?= base_url('neraca/sort') ?>" method="POST">
                                        <tr>
                                            <td>Tanggal Awal </td>
                                            <td ><input type="date" class="form-control" id="tglawall" name="tglawall" value="<?= '0000-00-00' ; ?>"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal Akhir </td>
