                    ...
                    <div class="row">                                      
                      <div class="col-md-6 col-md-6 col-sm-12">   
                        <i>( * ) Wajib di Isi</i>
                          ...
                          <div class="form-group has-feedback">
                              <a href="<?= base_url('Piutang/') ?>" class="btn btn-primary btn-labeled"><i class="fa fa-arrow-left"></i>Kembali</a>
                                        ...
                                        <div class="pull-right w-100">
                                          <table class="bg-danger">
                                              <tr style="font-size: 20px;">
                                                <td style="width: 200px;">Jumlah Hutang</td>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-12 col-md-12 sm-12">
                                        <div class="pull-right w-100">
                                          <table class="bg-danger">
                                              <tr style="font-size: 20px;">
                                                <td style="width: 200px;">Saldo Koperasi</td>
                                                <td style="width: 2px;">:</td>
                                                <?php 
                                                $saldoawal = 0;
                                                foreach ($kas as $kas) {
                                                  if($kas['debetk'] == 'koperasi'){

                                                    $saldoawal = $saldoawal + $kas['nominal'];
                                                  } else {

                                                    $saldoawal = $saldoawal - $kas['nominal'];
                                                  }
                                                } ?>
                                                <input type="hidden" name="saldokoperasi" value="<?= $saldoawal ?>">
                                                <input type="hidden" name="saldoBox" id="saldoBox">
                                                <td id="saldokop" style="text-align: right;" value="<?= $saldoawal ?>">Rp. <?= number_format($saldoawal); ?></td>
                                              </tr>
                                          </table>
                                        </div>                        
                                      </div>
