                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                       <div class="container-fluid">
                                        ...
                                        <div class="row">
                                                <div class="col-lg-3 col-md-4 col-sm-12" style="margin-left: -23px;">
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <select class="form-control js-states nameMember" disabled id="js-states"  name="nama">
                                                ...
                                                <input type="hidden" value="Piutang" name="kategori" id="kategoribp">
                                                <div class="col-lg-1 col-md-1 col-sm-12" style="padding: 0;">
