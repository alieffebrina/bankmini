...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2020 at 06:00 PM
...
(1, '1.1', 'kas', 'a', '1', '0', '0', 1, '2020-11-25 02:38:47');
...
--
ALTER TABLE `tb_mastercoa`
  MODIFY `id_coa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
