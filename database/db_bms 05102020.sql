...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2020 at 05:16 PM
...
MySQL - 10.1.37-MariaDB : Database - db_bms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_bms` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Data for the table `tb_historikas` */

insert  into `tb_historikas`(`id_histori_kas`,`kode_kas`,`jenis`,`nominal`,`saldo`,`tgltransaksi`) values 
(28,'KM051020200001','kas masuk',10000000,10000000,'2020-10-01 12:53:03'),
(29,'KK051020200001','kas keluar',6000000,4000000,'2020-10-02 12:54:46'),
(30,'KK051020200002','kas keluar',2000000,2000000,'2020-10-03 01:00:58'),
(31,'KM051020200002','kas masuk',20000000,22000000,'2020-10-06 01:01:31');
...
/*Data for the table `tb_kaskeluar` */

insert  into `tb_kaskeluar`(`id_kk`,`tgltransaksi`,`keterangan`,`nominal`,`kode_kas_keluar`,`id_user`,`status_jurnal`) values 
(4,'2020-10-02 12:54:46','dana buat pembangunan',6000000,'KK051020200001',1,'0'),
(5,'2020-10-03 01:00:58','-',2000000,'KK051020200002',1,'0');
...
CREATE TABLE `tb_kasmasuk` (
  ...
  `keterangan` varchar(255) DEFAULT NULL,
  `nominal` int(11) DEFAULT NULL,
  `kode_kas_masuk` char(255) DEFAULT NULL,
  `id_user` int(11) DEFAULT NULL,
  `statusjurnal` enum('0','1') DEFAULT NULL,
  PRIMARY KEY (`id_km`)
...
insert  into `tb_kasmasuk`(`id_km`,`tgltransaksi`,`keterangan`,`nominal`,`kode_kas_masuk`,`id_user`,`statusjurnal`) values 
(5,'2020-10-01 12:53:03','bantuan dari pemerintah',10000000,'KM051020200001',1,'0'),
(6,'2020-10-06 01:01:31','-',20000000,'KM051020200002',1,'0');
...
/*Data for the table `tb_mastercoa` */

insert  into `tb_mastercoa`(`id_coa`,`kode_coa`,`akun`,`keterangan`,`neraca`,`perubahan_modal`,`laba_rugi`,`id_user`,`tglupdate`) values 
(11,'2','Akun 2','aktiva tetap  ','0','1','0',1,'2020-10-01 04:44:54'),
(15,'9','Akun 1','aktiva bebas   ','1','0','0',1,'2020-10-04 07:18:43'),
(16,'3','Akun 3','a oo  ','0','1','0',1,'2020-10-01 04:45:44'),
(17,'4','Akun 4','Akun 4 ','1','1','1',1,'2020-10-04 07:12:37'),
(19,'10','akun 9','aktiva   ','1','1','1',1,'2020-10-04 07:48:50'),
(23,'11','akun 11','aktivaaa ','0','1','0',1,'2020-10-04 07:52:22');
...
/*Data for the table `tb_mastertransaksi` */
...
/*Data for the table `tb_tipeuser` */
...
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
COMMIT;
...
(68,1,'2020-10-01 20:38:19',0,'Logout'),
(69,1,'2020-10-01 20:38:29',0,'Login'),
(70,1,'2020-10-05 00:15:52',0,'Logout'),
(71,1,'2020-10-05 00:15:56',0,'Login');

/*Table structure for table `v_siswa` */
...
/*View structure for view v_siswa */
